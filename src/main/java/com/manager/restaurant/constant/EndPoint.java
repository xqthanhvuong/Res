...
public class EndPoint {
    public static final String[] PUBLIC_ENDPOINTS = {"bills/payment-all-bill/{idTable}","bills/get-all-order-client/{idTable}","bills/order","food/get-by-id-table-client/{idTable}","food/get/{idMenu}","menu/get/*","otp/sendOTP"
